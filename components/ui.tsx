...
export default function UI() {
  ...
  return (
    ...
    <div className='w-full flex justify-evenly items-center text-4xl absolute py-5 z-50 bg-black/30 top-0 backdrop-blur-sm'>
        ...
        <div className='bg-white w-auto h-auto flex flex-col justify-center items-center p-6 text-center rounded-full'><div>{target.sound}</div><div className='text-xs'>{user.name}</div></div>
